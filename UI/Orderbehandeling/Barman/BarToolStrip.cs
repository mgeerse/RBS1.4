...
namespace UI
{
    public class BarToolStrip
    {
        ...
        public BarToolStrip(Barman Barman, Panel Panel, Timer Timer1, Medewerker Medewerker, MainForm MainForm)
        {
        ...
        {
            BarmanOrderScherm BOS = new BarmanOrderScherm();
            ...
            Barman.Controls.Add(BOS.MaakControls(Panel));
            Timer1.Start();
        ...
        void TSB2_Click(object sender, EventArgs e, ToolStripButton TSB2, ToolStripButton TSB3)
        {
            ...
            Barman.Controls.Add(BOS.MaakGeschiedenis(Panel));
